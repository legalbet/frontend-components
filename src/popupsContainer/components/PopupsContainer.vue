...
import { PopupName } from '@/popupsContainer/composables/popupStore/types';
...
const popupComponents: Partial<Record<PopupName, Component>> = {
  ...
  [PopupName.CookiesPopupWithChoice]: defineAsyncComponent(
    () => import('@/types/external-types/components/cookiesPopupWithChoice/CookiesPopupWithChoice.vue')
  ),
  [PopupName.NotPartners]: defineAsyncComponent(
    () => import('@/types/external-types/components/notPartnerPopup/NotPartnerPopup.vue')
  ),
  [PopupName.BookNotSupportedByGeoPopup]: defineAsyncComponent(
    () => import('@/types/external-types/components/BookNotSupportedByGeoPopup/BookNotSupportedByGeoPopup.vue')
  ),
  [PopupName.BonusCardPopup]: defineAsyncComponent(
    () => import('@/types/external-typescommonComponents/bonusCard/BonusModal.vue')
  ),
  ...
  [PopupName.FilterPopup]: defineAsyncComponent(() => import('@/filter/components/FilterPopup.vue')),
  [PopupName.LockedDayPopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/LockedDayPopup.vue')
  ),
  [PopupName.ActivityInfoPopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/ActivityInfoPopup.vue')
  ),
  [PopupName.OnboardingPopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/OnboardingPopup.vue')
  ),
  [PopupName.LegalConsentPopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/LegalConsentPopup.vue')
  ),
  [PopupName.GameOverPopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/GameOverPopup.vue')
  ),
  [PopupName.BonusGamePopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/BonusPopup.vue')
  ),
  [PopupName.SocialMediaSharePopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/SocialMediaSharePopup.vue')
  ),
  [PopupName.SecretCollectablePopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/SecretCollectablePopup.vue')
  ),
  [PopupName.PauseGamePopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/PauseGamePopup.vue')
  ),
  [PopupName.PartnersActivityPopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/PartnersActivityPopup.vue')
  ),
  [PopupName.InvitePopup]: defineAsyncComponent(
    () => import('@/types/external-typescomponents/popups/InvitePopup.vue')
  ),
  [PopupName.BestBonusBtn]: defineAsyncComponent(
    () => import('@/types/external-typescommonComponents/BestBonusModal.vue')
  ),
